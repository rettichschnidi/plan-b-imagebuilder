...
(
  ...
  make image PROFILE=${device} EXTRA_IMAGE_NAME=PlanB PACKAGES="-ppp -ppp-mod-pppoe libustream-openssl plan-b-tor iperf3 curl ca-certificates ca-bundle" FILES="${files_dir}"
)
